...
namespace ORASINO_DESKTOP {
    ...
    public partial class DataSet1 : global::System.Data.DataSet {
        ...
        public partial class AccountsDataTable : global::System.Data.TypedTableBase<AccountsRow> {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow AddAccountsRow(string Student_ID, string Password) {
            ...
            [global::System.Diagnostics.DebuggerNonUserCodeAttribute()]
            [global::System.CodeDom.Compiler.GeneratedCodeAttribute("System.Data.Design.TypedDataSetGenerator", "17.0.0.0")]
            public AccountsRow FindByStudent_ID(string Student_ID) {
        ...
        public partial class AccountsRow : global::System.Data.DataRow {
            ...
            public string Student_ID {
                get {
                    return ((string)(this[this.tableAccounts.Student_IDColumn]));
                }
                set {
                    this[this.tableAccounts.Student_IDColumn] = value;
                }
            }
...
namespace ORASINO_DESKTOP.DataSet1TableAdapters {
    ...
    public partial class AccountsTableAdapter : global::System.ComponentModel.Component {
        ...
        private void InitAdapter() {
            ...
            this._adapter.DeleteCommand.CommandText = "DELETE FROM `Accounts` WHERE ((`Student ID` = ?) AND ((? = 1 AND `Password` IS NU" +
                "LL) OR (`Password` = ?)))";
            ...
            this._adapter.InsertCommand.CommandText = "INSERT INTO `Accounts` (`Student ID`, `Password`) VALUES (?, ?)";
            ...
            this._adapter.UpdateCommand.CommandText = "UPDATE `Accounts` SET `Student ID` = ?, `Password` = ? WHERE ((`Student ID` = ?) " +
        ...
        private void InitConnection() {
            ...
            this._connection.ConnectionString = "Provider=Microsoft.ACE.OLEDB.12.0;Data Source=|DataDirectory|\\Orasino_Accounts.ac" +
        ...
        private void InitCommandCollection() {
            ...
            this._commandCollection[0].CommandText = "SELECT [Student ID], [Password] FROM Accounts";
            this._commandCollection[0].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1] = new global::System.Data.OleDb.OleDbCommand();
            this._commandCollection[1].Connection = this.Connection;
            this._commandCollection[1].CommandText = "SELECT [Student ID], [Password] FROM Accounts WHERE [Student ID] = ? AND [Passwor" +
                "d] = ?";
            this._commandCollection[1].CommandType = global::System.Data.CommandType.Text;
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Student_ID", global::System.Data.OleDb.OleDbType.WChar, 10, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Student ID", global::System.Data.DataRowVersion.Current, false, null));
            this._commandCollection[1].Parameters.Add(new global::System.Data.OleDb.OleDbParameter("Password", global::System.Data.OleDb.OleDbType.WChar, 20, global::System.Data.ParameterDirection.Input, ((byte)(0)), ((byte)(0)), "Password", global::System.Data.DataRowVersion.Current, false, null));
        }
        ...
        public virtual DataSet1.AccountsDataTable GetDataByStudentIDPassword(string Student_ID, string Password) {
        ...
        public virtual int Delete(string Original_Student_ID, string Original_Password) {
        ...
        public virtual int Insert(string Student_ID, string Password) {
            if ((Student_ID == null)) {
                throw new global::System.ArgumentNullException("Student_ID");
            }
            else {
        ...
        public virtual int Update(string Student_ID, string Password, string Original_Student_ID, string Original_Password) {
            if ((Student_ID == null)) {
                throw new global::System.ArgumentNullException("Student_ID");
            }
            else {
        ...
        [global::System.ComponentModel.Design.HelpKeywordAttribute("vs.data.TableAdapter")]
        [global::System.ComponentModel.DataObjectMethodAttribute(global::System.ComponentModel.DataObjectMethodType.Update, true)]
        public virtual int Update(string Password, string Original_Student_ID, string Original_Password) {
            return this.Update(Original_Student_ID, Password, Original_Student_ID, Original_Password);
        }
    }
